            ...
            <footer className="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
                <div className="flex-w p-b-90">
                    ...
                    <div className="w-size7 p-t-30 p-l-15 p-r-15 respon4">
                        ...
                        <ul>
                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Men </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Women </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Dresses </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Sunglasses </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="w-size7 p-t-30 p-l-15 p-r-15 respon4">
                        ...
                        <ul>
                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Search </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> About Us </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Contact Us </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Returns </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="w-size7 p-t-30 p-l-15 p-r-15 respon4">
                        ...
                        <ul>
                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Track Order </a>
                            </li>
                            ...
                            <li className="p-b-9">
                                <a href="#" className="s-text7"> Shipping </a>
                            </li>

                            <li className="p-b-9">
                                <a href="#" className="s-text7"> FAQs </a>
                            </li>
                        </ul>
                    </div>
